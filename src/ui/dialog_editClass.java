...
/**
 * <h1> dialog_editClass </h1>
 * 
 * @author Zwe_Min_Oo
 * @version 1.0.0
 * @since 2018-06-30
 */
public class dialog_editClass extends JDialog {
	...
	public static void main(String[] args) {
		try {
			dialog_editClass dialog = new dialog_editClass();
	...
	public dialog_editClass() {
		...
		}
		{
			...
			btnChoose.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					dialog_cCourse = new dialog_chooseCourse();
		...
		lblStartDate.setBounds(208, 52, 58, 14);
		contentPanel.add(lblStartDate);
		
		JLabel lblEndDate = new JLabel("End Date");
		lblEndDate.setBounds(208, 111, 58, 14);
		contentPanel.add(lblEndDate);
		
		dcStart = new JDateChooser();
		dcStart.setBounds(287, 52, 91, 20);
		contentPanel.add(dcStart);
		
		dcEnd = new JDateChooser();
		dcEnd.setBounds(287, 111, 91, 20);
		contentPanel.add(dcEnd);
		
		btnSave = new JButton("Save");
		btnSave.setBounds(287, 148, 89, 23);
